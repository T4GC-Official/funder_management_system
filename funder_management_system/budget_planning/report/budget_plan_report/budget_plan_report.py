...
def execute(filters=None):
	columns = [
		{
			"fieldname": "name",
			"label": "Budget Plan / Budget Category / Budget Sub-Category",
			"fieldtype": "HTML",
			"width": 350,
		},
		...
		{"fieldname": "total_quarter_1_budget", "label": "Q1 Budget", "fieldtype": "Currency", "width": 200},
		{"fieldname": "total_quarter_2_budget", "label": "Q2 Budget", "fieldtype": "Currency", "width": 200},
		{"fieldname": "total_quarter_3_budget", "label": "Q3 Budget", "fieldtype": "Currency", "width": 200},
		{"fieldname": "total_quarter_4_budget", "label": "Q4 Budget", "fieldtype": "Currency", "width": 200},
		{"fieldname": "subtotal", "label": "Sub Total", "fieldtype": "Currency", "width": 200},
	...
	for plan in budget_plans:
		...
		for breakdown in budget_breakdowns:
			...
			category_totals[category]["sub_categories"][sub_category]["total_quarter_1_budget"] += breakdown[
				"quarter_1_budget"
			]
			category_totals[category]["sub_categories"][sub_category]["total_quarter_2_budget"] += breakdown[
				"quarter_2_budget"
			]
			category_totals[category]["sub_categories"][sub_category]["total_quarter_3_budget"] += breakdown[
				"quarter_3_budget"
			]
			category_totals[category]["sub_categories"][sub_category]["total_quarter_4_budget"] += breakdown[
				"quarter_4_budget"
			]
		...
		for category, cat_totals in category_totals.items():
			category_subtotal = (
				cat_totals["total_quarter_1_budget"]
				+ cat_totals["total_quarter_2_budget"]
				+ cat_totals["total_quarter_3_budget"]
				+ cat_totals["total_quarter_4_budget"]
			)
			...
			for sub_category, sub_totals in cat_totals["sub_categories"].items():
				sub_total = (
					sub_totals["total_quarter_1_budget"]
					+ sub_totals["total_quarter_2_budget"]
					+ sub_totals["total_quarter_3_budget"]
					+ sub_totals["total_quarter_4_budget"]
				)
