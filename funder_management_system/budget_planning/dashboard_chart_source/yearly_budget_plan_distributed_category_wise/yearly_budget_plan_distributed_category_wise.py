...
def get(
    ...
    time_interval=None,
    budget_plan=None,
    heatmap_year=None, # Accept the budget_plan filter here
    **kwargs  # Accept any additional arguments passed
):
    labels, datapoints = [], []
    ...
    return {
        ...
        "datasets": [
            {
                "name": _("Total Sub Total by Budget Category"),
                "values": datapoints,
            }
        ],
    }
