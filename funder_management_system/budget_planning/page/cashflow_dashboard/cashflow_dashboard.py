...
import json
from funder_management_system.utils import total_conversion, normalize_financial_years
...
def get_budget_category_wise(financial_years=None):
    ...
    return {
        ...
        "datasets": [
            {
                "name": _("Yearly Budget Plan Distributed Category Wise"),
                "values": datapoints
            }
        ]
    }
...
def get_budget_sub_category_wise(financial_years=None):
    ...
    return {
        ...
        "datasets": [
            {
                "name": _("Yearly Budget Plan Distributed Sub Category Wise"),
                "values": datapoints
            }
        ]
    }
...
def get_budget_level_utilisation(financial_years=None):
    ...
    return {
        ...
        "datasets": [
            {
                "name": _("Planned Budget"),
                "values": yearly_budget_values
            },
            {
                "name": _("Utilised Budget"),
                "values": utilised_amount_values
            }
        ]
    }
