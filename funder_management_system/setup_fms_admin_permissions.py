...
from .utils import add_permissions, create_roles_if_missing
...
def setup_budget_allocation_module_roles():
	...
	role_doctypes_permissions_level_mapping = [
		(
			"Fundraising Admin",
			"Budget Category",
			{"read": 1, "write": 1, "create": 1, "delete": 1, "select": 1, "import": 1, "export": 1},
			0,
		),
		(
			"Fundraising Admin",
		...
		(
			"Fundraising Admin",
			"Financial Year",
			{"read": 1, "write": 1, "create": 1, "delete": 1, "import": 1, "export": 1},
			0,
		),
		(
			"Fundraising Admin",
...
def setup_donor_engagement_module_roles():
	...
	role_doctypes_permissions_level_mapping = [
		...
		(
			"Fundraising Admin",
			"Donor",
			{"read": 1, "write": 1, "create": 1, "delete": 1, "report": 1, "import": 1, "export": 1},
			0,
		),
		(
			"Fundraising Admin",
...
def setup_fms_fundraising_admin_must_have_role():
	permissions_map = [
		...
		(
			...
			0,
		),  # Typo Role profiles, changed to Role Profile
		("Fundraising Admin", "Custom DocPerm", {"read": 1, "write": 1, "create": 1}, 0),
		("Fundraising Admin", "User", {"read": 1, "write": 1, "create": 1, "delete": 1}, 0),
		# permission level 1
		...
		(
			...
			{"read": 1, "write": 1},
			1,
		),  # Role Profile requires level 1 permission for fundraising admin
		("Fundraising Admin", "LDAP Settings", {"read": 1, "write": 1, "create": 1, "delete": 1}, 0),
		("Fundraising Admin", "Page", {"read": 1}, 0),
		("Fundraising Admin", "Module Profile", {"read": 1}, 0),
		("Fundraising Admin", "Data Import", {"read": 1, "write": 1, "create": 1, "delete": 1}, 0),
