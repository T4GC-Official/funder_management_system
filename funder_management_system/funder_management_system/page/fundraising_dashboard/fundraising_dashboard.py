...
from funder_management_system.utils import normalize_financial_years, total_conversion, get_fy_date_ranges_from_doctype
...
def get_funds_received_vs_utilised(financial_years=None):
    ...
    return {
        ...
        "datasets": [
            {
                "name": _("Funds Received"),
                "values": received
            },
            {
                "name": _("Funds Utilised"),
                "values": utilised
            }
        ]
    }
